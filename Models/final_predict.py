...
if __name__ == '__main__':
    ...
    projects_df['is_exciting'] = (0.7 * model1['is_exciting'] + 0.3 * model2['is_exciting']) * projects_df['discount']

    projects_df = projects_df[['projectid', 'is_exciting']]

    projects_df.to_csv(os.path.join('../Prediction', 'final_result.csv'), index=False)