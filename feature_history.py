...
def __acc_cnt(df, list_of_vars, list_of_cnt_cols):
    ...
    for var in list_of_vars:
        ...
        for cnt_col in list_of_cnt_cols:
            cumsum_col = cnt_col + '_acc_by_' + var
            rate_col = cnt_col + '_rate_by_' + var
...
print df[df['group'] != 'test'][['projectid', 'group', 'teacher_acctid', 'is_exciting', 'is_exciting_cnt', 'is_exciting_cnt_acc_by_teacher_acctid', 'cum_cnt_by_teacher_acctid', 'is_exciting_cnt_rate_by_teacher_acctid']].head()
